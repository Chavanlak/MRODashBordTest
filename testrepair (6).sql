...
CREATE TABLE `statustracking` (
  ...
  `dateReturnedToSupplier` datetime DEFAULT NULL,
  `dateReceivedAfterClaim` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
ALTER TABLE `statustracking`
  ...
  ADD CONSTRAINT `statustracking_ibfk_2` FOREIGN KEY (`userId`) REFERENCES `user` (`userId`) ON DELETE NO ACTION ON UPDATE NO ACTION;
